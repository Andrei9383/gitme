        ...
        <div className="container mx-auto px-4 md:px-8">
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start py-8 md:py-16 justify-between">
            ...
            >
              ...
              <Card className="shadow-none border-none align-bottom align-items-end flex">
            ...
            >
              <div className="md:sticky md:top-8 space-y-6">
                {/* Analyzer Card */}
                <Collapsible open={!analyzerCollapsed} onOpenChange={(open) => setAnalyzerCollapsed(!open)}>
                  <Card>
                    <CardHeader className="pb-3">
                      <CollapsibleTrigger asChild>
                        <Button variant="ghost" className="w-full justify-between p-0 h-auto">
                          <div className="text-left">
                            <CardTitle className="text-lg">GitHub Repository Analyzer</CardTitle>
                            <CardDescription className="mt-1">
                              Download and analyze repository files
                            </CardDescription>
                          </div>
                          {analyzerCollapsed ? (
