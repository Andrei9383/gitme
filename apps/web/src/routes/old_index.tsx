...
export const Route = createFileRoute("/old_index")({
...
function HomeComponent() {
  ...
  // return (
  //   <div className="min-h-screen flex flex-col bg-[#f2dfb2] dark:bg-gray-900 text-[#1f1a17] dark:text-gray-100 transition-colors">
